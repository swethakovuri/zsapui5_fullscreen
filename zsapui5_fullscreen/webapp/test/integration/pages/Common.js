sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zsapui5fullscreen/zsapui5_fullscreen/app", ".html");
		...
		return Opa5.extend("zsapui5fullscreen.zsapui5_fullscreen.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zsapui5fullscreen/zsapui5_fullscreen/localService/mockserver"], function (mockserver) {
